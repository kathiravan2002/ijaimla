    ...
    return (
        <div className='flex flex-row'>
            ...
            <div className="text-justify max-w-[90rem] mx-auto lg:pr-2 pr-2 lg:p-0 p-2 ">
                ...
                <p className="text-black text-base  poppins-regular"> The International Journal of Artificial Intelligence and Machine Learning Applications (IJAIMLA) aims to provide a global platform for publishing high-quality research in Artificial Intelligence (AI) and Machine Learning (ML). The journal focuses on Theories, Methods, and Real-World Applications in areas such as Deep Learning, Natural Language Processing, Computer Vision, and AI-driven Decision-making.</p>
                ...
                <div className='text-center mb-6 mt-3'>
                    <button className="bg-[#1A4480] text-white px-4 py-2 rounded-lg hover:bg-[#1d3c66] transition duration-300" >
                        <div className='flex justify-between gap-3 poppins-bold'>  Submit Manuscript
